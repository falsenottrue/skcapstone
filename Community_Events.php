...
<html lang="en">
  ...
  <body class="vertical light">
            ...
            <tbody>
                <tr>
                    <td>
                        <h3>
                            <h1>
                                <p><a href="sport_event.php"><i class="fa-solid fa-basketball fa-xl" style="color: #ff4d00;"></i></a></p>
                            </h1>
                        </h3>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <h3>
                            <h1>
                                <p><a href="education_ai.php"><i class="fa-solid fa-book-open fa-xl" style="color: #432718;"></i></a></p>
                            </h1>
                        </h3>
                    </td>
                    <td>
                    ...
                    <td>AI Assisted Educational Programs</td>
                </tr>
                <tr>
                    <td>
                        <h3>
                            <h1>
                                <p><a href="Scholar_Program.php"><i class="fa-solid fa-brain fa-xl" style="color: #ca3de6;"></i></p>
                            </h1>
                        </h3>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <h3>
                            <h1>
                                <p><a href="dental_mission.php"><i class="fa-solid fa-teeth-open fa-xl" style="color: #63E6BE;"></i></a></p>
                            </h1>
                        </h3>
                    </td>
                    <td>
                    ...
                    <td>Offers free dental checkups, cleanings, and treatments to improve oral health in the community.</td>
                </tr>
                <tr>
                    <td>
                        <h3>
                            <h1>
                                <p><a href="Feeding_Program.php"><i class="fa-solid fa-utensils fa-xl" style="color: #3a645d;"></i></p>
                            </h1>
                        </h3>
                    </td>
                    <td>
                    ...
                    <td>Delivers nutritious meals to children and families in need to support health and well-being.</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    // Simulate a click on the collapse button to collapse the sidebar
